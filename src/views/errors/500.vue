...
<template>
    <div
        class="flex flex-col items-center justify-center w-full h-screen space-x-8 space-y-16 lg:flex-row lg:space-y-0 2xl:space-x-0"
    >
        <div
            class="flex flex-col items-center justify-center w-full text-center lg:w-1/2 lg:px-2 xl:px-0"
        >
            <p class="font-bold tracking-wider text-gray-300 text-7xl md:text-8xl lg:text-9xl">
                500
            </p>
        ...
        <div class="flex justify-center w-1/2 p-4 lg:h-full lg:items-end">
            <svg
